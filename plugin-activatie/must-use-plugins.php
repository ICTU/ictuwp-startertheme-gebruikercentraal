	...
	$config = array(
		...
		'strings' => array(
			...
			'notice_can_install_recommended'  => _nx_noop(
				...
				'This theme recommends the following plugins: %1$s.', 'Plugins installer', 'gctheme' ),
			'notice_ask_to_update'            => _nx_noop(

				'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.',
				'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.', 'Plugins installer', 'gctheme' ),
			'notice_ask_to_update_maybe'      => _nx_noop(

				'There is an update available for: %1$s.',
				'There are updates available for the following plugins: %1$s.', 'Plugins installer', 'gctheme' ),
			'notice_can_activate_required'    => _nx_noop(

				'The following required plugin is currently inactive: %1$s.',
				'The following required plugins are currently inactive: %1$s.', 'Plugins installer', 'gctheme' ),
			'notice_can_activate_recommended' => _nx_noop(

				'The following recommended plugin is currently inactive: %1$s.',
				'The following recommended plugins are currently inactive: %1$s.', 'Plugins installer', 'gctheme' ),
			...
			'activate_link'                   => _nx_noop(
				...
				'Begin activating plugins', 'Plugins installer', 'gctheme' ),
			'return'                          => _x( 'Return to Required Plugins Installer', 'Plugins installer', 'gctheme' ),
