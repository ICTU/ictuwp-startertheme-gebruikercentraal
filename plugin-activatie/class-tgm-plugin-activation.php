	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			$this->strings = array(
				...
				'activated_successfully'          => __( 'This following plugin was activated successfully:', 'tgmpa' ),
	...
	class TGMPA_List_Table extends WP_List_Table {
			...
			foreach ( $this->view_totals as $type => $count ) {
				...
				switch ( $type ) {
					case 'all':
						...
						$text = _nx( 'Alles <span class="count">(%s)</span>', 'All <span class="count">(%s)</span>', $count, 'plugins', 'tgmpa' );
						break;
					case 'install':
						/* translators: 1: number of plugins. */
						$text = _n( 'Vereiste plugins <span class="count">(%s)</span>', 'To Install <span class="count">(%s)</span>', $count, 'tgmpa' );
						break;
					case 'update':
						/* translators: 1: number of plugins. */
						$text = _n( 'Update Beschikbaar <span class="count">(%s)</span>', 'Update Available <span class="count">(%s)</span>', $count, 'tgmpa' );
						break;
					case 'activate':
						/* translators: 1: number of plugins. */
						$text = _n( 'Nog niet geactiveerd <span class="count">(%s)</span>', 'To Activate <span class="count">(%s)</span>', $count, 'tgmpa' );
						break;
					default:
						$text = '';
						break;
		...
		protected function get_row_actions( $item ) {
			...
			if ( ! $this->tgmpa->is_plugin_installed( $item['slug'] ) ) {
				...
				$actions['install'] = __( 'Installeer %2$s', 'tgmpa' );
			} else {
				...
				if ( $this->tgmpa->can_plugin_activate( $item['slug'] ) ) {
					/* translators: %2$s: plugin name in screen reader markup */
					$actions['activate'] = __( 'Activeer %2$s', 'tgmpa' );
				}
			}
