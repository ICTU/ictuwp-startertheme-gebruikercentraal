	...
	public static function get_options() {
		return array(
            ...
            array(
                'id' => 'email_tab',
                'type' => 'tab',
                'label' => __( 'Email notifications ', 'minerva-kb' ),
                'icon' => 'fa-envelope-o'
            ),
            array(
                'id' => 'email_notify_info',
                'type' => 'info',
                'label' => 'Email functionality is experimental and depends on proper WordPress and server configuration to work correctly. ' .
            ...
            array(
                ...
                'type' => 'checkbox',
                'label' => __( 'Notify on new feedback submitted', 'minerva-kb' ),
                'default' => false,
                'description' => __( 'You will receive email once feedback is submitted for article', 'minerva-kb' ),
            ),
            array(
                'id' => 'email_notify_feedback_subject',
                'type' => 'input',
                'label' => __( 'Subject field for feedback notifications', 'minerva-kb' ),
                'default' => __( 'New feedback received for KB article', 'minerva-kb' ),
                'dependency' => array(
            ...
            array(
                'id' => 'email_notify_feedback_message',
                'type' => 'input',
                'label' => __( 'Message label for feedback notifications', 'minerva-kb' ),
                'default' => __( 'You have received new feedback for article: ', 'minerva-kb' ),
                'dependency' => array(
                    'target' => 'email_notify_feedback_switch',
                    'type' => 'EQ',
                    'value' => true
